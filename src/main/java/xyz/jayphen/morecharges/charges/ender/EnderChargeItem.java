...
public class EnderChargeItem extends WindChargeItem {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        if (!world.isClient()) {
            ...
            EnderChargeEntity enderChargeEntity = new EnderChargeEntity(user, world, vec3d.getX(), vec3d.getY(), vec3d.getZ());
            enderChargeEntity.setVelocity(user, user.getPitch(), user.getYaw(), 0.0F, 1.5F, 1.0F);
            world.spawnEntity(enderChargeEntity);
        }
